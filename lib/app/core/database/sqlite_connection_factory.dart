...
class SqliteConnectionFactory {
  ...
  factory SqliteConnectionFactory() {
    _instance ??= SqliteConnectionFactory._();  //Esta linha diz "Se o _instance não foi nullo, devo abrir uma nova conexão"
    return _instance!;
  }
    ...
    if(_db == null) {
      ...
      await _lock.synchronized(() async {
        if(_db == null) {
          ...
          var pathDatabase = join(databasePath, _databaseName);
